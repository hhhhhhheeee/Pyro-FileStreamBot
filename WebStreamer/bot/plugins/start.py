    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                return
        await m.reply_text(
            text='├ 🧬 Bot Owner : @ShivamTheSkywalkern\├ 💾 Functionality : File to link*\n\├ 🛡Support group : 😬n\├ 🛠Channel : @XStream_Flixn\├ 🔼 Link Max Speed : 4MB/sn\├ 🧲Forward File to get linkn\╰──「 🚸@XStream_Flix🚸 」',
            reply_markup=InlineKeyboardMarkup(
                [
