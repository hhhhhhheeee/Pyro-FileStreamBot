        ...
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/XStream_Flix).",
                        parse_mode="markdown",
                ...
                return
        await m.reply_text(
            text='╭──「 ⭕️ BOT INFO ⭕️  」 n\│├ 🧬 Bot Owner : @ShivamTheSkywalker n\├ 💾 Functionality : File to link n\├ 🛡Support group : 😬 n\├ 🛠Channel : @XStream_Flix n\├ 🔼 Link Max Speed : 4MB/s n\├ 🧲Forward File to get link n\╰──「 🚸@XStream_Flix🚸 」',
            reply_markup=InlineKeyboardMarkup(
                [
